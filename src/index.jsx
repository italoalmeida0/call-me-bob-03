...
const LS_SOLVED_KEY = "bob03_solved_chores";
const LS_CODE_PREFIX = "bob03_chore_code_";
const REPO_URL = "https://github.com/italoalmeida0/call-me-bob-03";
const PREV_SITE = null;
const NEXT_SITE = {
      ...
      <div class="max-w-4xl mx-auto px-5 py-8 md:py-12">
        ...
        <div class="text-center mb-10">
          ...
          <p class="text-[#a8a29e] text-base md:text-lg max-w-xl mx-auto leading-relaxed">
            Bob has a to-do list. You have Python. Help Bob sort his seed
            packets, decode the owl post, paint the fence and whisper to
            scarecrows — one chore at a time, right in your browser.
          </p>
          <a
            href={REPO_URL}
            target="_blank"
  ...
  return (
    <div class="h-full flex flex-col overflow-hidden">
      ...
      <div class="status-bar">
        ...
        <span class="text-[#44403c]">call-me-bob 03</span>
      </div>
    </div>
  );
}
